...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_theme_page(__('Theme Options', __( 'Настройки темы', 'wp-shop' )), __( 'Настройки темы', 'wp-shop' ), 'edit_theme_options', 'options-framework','optionsframework_page');
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
			...
			<div id="optionsframework-submit">
				<input type="submit" class="button-primary" name="update" value="<?php _e( 'Сохранить' , 'wp-shop' ); ?>" />
				<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Сбросить' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Нажмите OK для сброса. Все настройки темы будут утеряны!' , 'wp-shop' ) ); ?>' );" />
				<div class="clear"></div>
			</div>
			</form>
		</div> <!-- / #container -->
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __('Настройки по умолчанию восстановлены.' , 'wp-shop'), 'updated fade' );
	 ...
	 */
		...
		add_settings_error( 'options-framework', 'save_options', __('Настройки сохранены' , 'wp-shop'), 'updated fade' );
		return $clean;
	}
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Настройки темы' , 'wp-shop' ),
